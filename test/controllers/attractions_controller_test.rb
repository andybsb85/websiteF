...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { address: @attraction.address, description: @attraction.description, name: @attraction.name, openning_hours: @attraction.openning_hours, phone: @attraction.phone, website: @attraction.website }
    end
  ...
  test "should update attraction" do
    patch :update, id: @attraction, attraction: { address: @attraction.address, description: @attraction.description, name: @attraction.name, openning_hours: @attraction.openning_hours, phone: @attraction.phone, website: @attraction.website }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
